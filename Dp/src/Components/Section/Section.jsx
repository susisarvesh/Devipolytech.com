        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="flex flex-col justify-center">
            ...
            <p className="text-gray-700 mb-6 text-center md:text-lg lg:text-[20px] lg:text-start md:text-start">
              At Devi Polytech, we deliver precision CNC machining for plastics, metals, and drone parts. Using advanced technology, we ensure top-quality results for all your project needs. Experience excellence in every cut.
            </p>
          </div>
