  ...
  return (
    <div className="app">
      <nav>
          ...
          <div className="flex mx-auto justify-between w-5/6 py-4">
            ...
            <div className="flex items-center justify-between w-full gap-8">
              ...
              <div>
                ...
                >
                  <img
                    src="https://ik.imagekit.io/zhf0gkzac/Devipolytech/Preci-tech.png?updatedAt=1728989172018"
                    alt="DeviPolytech logo"
                    className="w-[164px]"
                  />
                </Link>
              </div>
        ...
        >
          <div className="px-8">
            <div className="flex flex-col items-center gap-6 font-bold tracking-wider">
