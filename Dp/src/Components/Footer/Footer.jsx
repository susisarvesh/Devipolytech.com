            ...
            <div className="flex flex-col gap-10 p-5 pb-[100px]">
                <div className="grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-7">
                    <div className="flex flex-row justify-center lg:justify-start">
                        <img src="https://ik.imagekit.io/zhf0gkzac/Devipolytech/Preci-tech.png?updatedAt=1728989172018" alt="logo" className="w-28"  />
                    </div>
                ...
                <div className="flex justify-center text-white ">
                    <p>Copyright &copy; 2024 DeviPolytech Pvt.Ltd.</p>
                </div>
            </div>
        </div>
    );
